...
const ButtonsBlock = ({ activeKey, saveProductData, mainLoading, checkedFormData, locateToDefaultProductPage, printTechMap, t }) =>
(
  <CCol className="p-0 d-flex justify-content-end">
    ...
    <CButton onClick={saveProductData}
...
const CreateSemiReadyHeaderContent = ({ saveProductData, activeKey, setActiveKey, mainLoading, locateToDefaultProductPage, checkedFormData, printTechMap, t }) =>
(
  <CRow className="p-0 m-0 d-flex justify-content-between align-items-center w-100">
    ...
    <ButtonsBlock activeKey={activeKey} printTechMap={printTechMap} saveProductData={saveProductData} mainLoading={mainLoading} checkedFormData={checkedFormData} locateToDefaultProductPage={locateToDefaultProductPage} t={t} />
  </CRow>
)

export default CreateSemiReadyHeaderContent
